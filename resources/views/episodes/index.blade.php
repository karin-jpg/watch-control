...
<div class="d-flex justify-content-between"">
	...
	<button class="btn btn-dark mb-2" onclick="checkUncheckAllEpisodes(this)">Check all</button>
</div>
<form method="post">
	@csrf
	<ul class="list-group">
		<input type="hidden" id="allChecked" value="false">
		@foreach($episodes as $episode)
			<li class="list-group-item d-flex justify-content-between align-itens-center">
					Episode {{ $episode->number }}
					<input type="checkbox" class="checkbox" name="episodes[]" value="{{ $episode->id }}">
			</li>
		@endforeach
	</ul>
